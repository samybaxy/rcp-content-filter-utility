...
if ( ! defined( 'RCP_FILTER_VERSION' ) ) {
	define( 'RCP_FILTER_VERSION', '1.0.59' ); // JetEngine flat URLs disabled - needs investigation
}
...
// Validate email and phone fields (allows transliteration for address fields)
...
// DISABLED - Still causing critical errors on remote server
...
add_action( 'plugins_loaded', function(): void {
    ...
    // Load the flat URLs class
    require_once RCP_FILTER_PLUGIN_DIR . 'includes/class-jetengine-flat-urls.php';
