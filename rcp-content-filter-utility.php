...
if ( ! defined( 'RCP_FILTER_VERSION' ) ) {
	define( 'RCP_FILTER_VERSION', '1.0.49' ); // Optimized - removed verbose logging, lean & efficient
}
...
// TEMPORARILY DISABLED: Testing Loqate transliteration feature - need to allow non-ASCII input
